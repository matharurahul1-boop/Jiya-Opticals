...
create table if not exists public.inventory (
  ...
  name text not null,
  category text not null check (category in ('Frames', 'Sunglasses', 'Eyewear Lens', 'Contact Lens', 'Goggles Lens', 'MPS', 'Repair', 'Optical Accessory', 'Reading Glasses', 'Equipment / Battery')),
  brand text not null,
